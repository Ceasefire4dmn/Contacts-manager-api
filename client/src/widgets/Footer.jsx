...
function Footer() {
    return (
        <Nav className="justify-content-center align-items-center pb-3" activeKey="/home" >
            <Nav.Item>
            ...
            <Nav.Item>
                <Nav.Link style={{ color: "#ffffff" }}  href="https://github.com/Ceasefire4dmn" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" fill="currentColor" class="bi bi-github me-1" viewBox="0 0 16 16">
            ...
            <Nav.Item>
                <Nav.Link style={{ color: "#ffffff" }} href="http://www.linkedin.com/in/aleksandra-trunova-9538bb325" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" fill="currentColor" class="bi bi-linkedin me-1" viewBox="0 0 16 16">
